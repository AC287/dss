...
function cambridge_script_enqueue() {
  ...
  wp_enqueue_style('customstyle',get_template_directory_uri().'/css/dss.css', array(), '1.0.0', 'all');
  ...
  wp_enqueue_script('customjs',get_template_directory_uri().'/js/dss.js', array('jquery'), '1.0.0', true);
